...
/*
 * реализация класса TProcessorView
 *
 *      Отображение процессора в интерфейсе
 *
*/
TProcessorView::TProcessorView(int n, QWidget *parent)
    : QWidget(parent)
{
    QFont font;
    ...
    QPalette p;
    p.setColor(QPalette::Window, QColor(218, 112, 214));
...
/*
 * реализация класса TWorkTaskView
 *
 *      Отображение решаемой/решенной задачи в интерфейсе
 *
*/
TWorkTaskView::TWorkTaskView(int n, int current_time, int time, QWidget *parent)
    : QWidget(parent)
{
    QFont font;
    QPalette p;

    p.setColor(QPalette::Window, QColor(0, 207, 255));
...
/*
 * реализация класса TTaskView
 *
 *      Отображение задания в спике/очереди заданий
 *
*/
...
/*
 * реализация класса TTaskRecordView
 *
 *      Отображение задания в списке с лучшим результатом
 *
*/
TTaskRecordView::TTaskRecordView(int n, int time, QWidget *parent)
    : QWidget(parent)
{
    ...
    execution_time = new QLabel("Время выполнения: " + QString().setNum(time) + "c.", this);
