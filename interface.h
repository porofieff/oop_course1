...
/*
 * описание класса TSettingsWindow
 *
 *      Окно, в котором можно установить параметры системы:
 *      сгенерировать список заданий или поставить
 *      нужное количество процессоров
 *
*/
...
/*
 * описание класса TControlWindow
 *
 *      Окно управления, в котором можно запусть
 *      систему или сбросить текущие параметры
 *
*/
...
/*
 * описание класса TProcessorsWindow
 *
 *      Окно в котором отображается работа системы в реальном времени,
 *      т.е. процессоры и задачи, которые выполняются в данный момент
 *      или уже были выполнены
 *
*/
...
/*
 * описание класса TTasksWindow
 *
 *      Окно, в котором отображается список сгенерированных заданий,
 *      которые требуется организовать в очередности,
 *      которой они будут поступать на выполнение
 *
*/
...
/*
 * описание класса TMainWindow
 *
 *      Главное окно приложения, в котором размещены
 *      остальные окна и происходит их соединение
 *
*/
